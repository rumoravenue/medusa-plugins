...
export declare type AzureAuthOption = {
    /**
     * Required
     ...
     */
    verifyCallback?: (container: MedusaContainer, req: Request, profile: any, strict?: AuthOptions['strict']) => Promise<null | {
        id: string;
    } | never>;
    expiresIn?: number;
};
export declare type AzureAuthOptions = {
